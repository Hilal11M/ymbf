...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| hilal ganteng
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| https://github.com/Hilal11M
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Kontol😂🤣🤣🤣🤣'''
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://youtube.com/channel/UCK2cziXBua6k7JFqojtMILw')
        moch_yayan()
    except KeyError:
...
def info_tools():
    ...
    print '\n %s[%s>%s] Author   : Moch hilal.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : private ngab ya🤣'%(N,H,N);time.sleep(0.07)
    ...
    print '\n %s[%s>%s] Instagram: https://gak punya gan🤣_'%(N,H,N);time.sleep(0.07)
